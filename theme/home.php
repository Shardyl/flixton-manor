...
<section class="page-hero">
  <div class="wrap">
    ...
    <h1>News &amp; Events</h1>
    <p class="page-hero-sub">The latest happenings, celebrations and updates from life at our home.</p>
  </div>
</section>
<section class="band">
  <div class="wrap">
    ...
    <?php else : ?>
      <p class="prose">No news posts yet. Please check back soon.</p>
    <?php endif; ?>
  </div>
</section>
<?php
